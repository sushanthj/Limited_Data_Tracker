    ...
    for g in gap:
        for f in folder:
            ...
            os.system("python3 predict.py "
                        "--gap {} --model {} --path {} --batch_size {} "
                        "--outroot {} --reverse {} --raw_outroot {}".format(g, model, f, batch_size, outroot, r, raw_outroot))
